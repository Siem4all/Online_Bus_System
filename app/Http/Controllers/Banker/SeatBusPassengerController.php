...
class SeatBusPassengerController extends Controller
{
    ...
    {
        //
        return view('banker.buspassenger');
    }
    ...
    public function store(Request $request)
    {
        ...
        $passenger = Passenger::where('id','LIKE','%'.$data.'%')->first();
                    ...
                    $num=' ';
                        return view('banker.seatbuspassenger',compact('bus','passenger','num','seats'));
                    }
                    else{
    ...
    public function display(Request $request)
    {
        ...
        return view('banker.seat.edit',compact('seat','sets'));
    }
