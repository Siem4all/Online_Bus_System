...
class ConductorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('banker.conductor.index', compact('conductors'));
    }
    ...
    {
        //
         return view('banker.conductor.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $conductor->save();
        return redirect('/bconductor')->with('success', trans('sentence.added'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('banker.conductor.edit',compact('conductor'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/bconductor')->with('success', trans('sentence.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        if($conductor->bus()->count() > 0){
          return redirect('/bconductor')->with('warning', 'First delete it from bus');
        }
        else{
            $conductor ->delete();
        
        return redirect('/bconductor')->with('success', trans('sentence.deleted'));
    }
    }
}
