...
class ScheduleController extends Controller
{
    ...
    public function create()
    {
        ...
        $routes = Route::all();
        $buses=Bus::all();
         return view('user.schedule.create',compact('routes','buses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $schedule->save();
        return redirect('/usschedule')->with('success', trans('sentence.added'));
                 }
            else{
    ...
    public function edit($id)
    {
        ...
        return
            view('user.schedule.edit',compact('schedule','routes','buses'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/usschedule')->with('success', trans('sentence.updated'));
                 }
            else{
             session()->flash('warning','Sorry, please, check route id!!');
        return redirect('/usschedule');
    ...
    public function destroy($id)
    {
        ...
        if($schedule->books()->count() > 0){
            return redirect('/usschedule')->with('warning', 'First delete it from booking');
        }
            $schedule->delete();
        return redirect('/usschedule')->with('success', trans('sentence.deleted'));
    }
}
