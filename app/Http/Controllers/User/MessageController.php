...
class MessageController extends Controller
{
   ...
   public function index()
    {
        ...
        return view('user.message.index', compact('messages','passengers'));
    }
    /**
    ...
    return redirect('/umessage')->with('success',trans('sentence.added'));
    }else{
           return redirect('/umessage')->with('warning',trans('sentence.booked')); 
        }
             }
        else{
            return redirect('/upassenger')->with('warning','Enter correct passenger id'); 
        }
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/umessage')->with('success', trans('sentence.updated'));
    }
 ...
 public function search(Request $request)
    ...
    public function destroy($id)
    {
        ...
        return redirect('/umessage')->with('success', trans('sentence.deleted'));
    }
}
