...
class ConductorController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $conductor->save();
        return redirect('/conductor')->with('success', trans('sentence.added'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/conductor')->with('success', trans('sentence.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        if($conductor->bus()->count() > 0){
          return redirect('/conductor')->with('warning', 'First delete it from bus');
        }
        else{
            $conductor ->delete();
        
        return redirect('/conductor')->with('success', trans('sentence.deleted'));
    }
    }
}
