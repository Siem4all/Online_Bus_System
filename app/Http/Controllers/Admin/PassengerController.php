...
class PassengerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/showseat/'.$code.'/'.$schedule);  
             }
    ...
    {
       //return view('admin.passenger.create',compact('passenger'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/passenger')->with('success', trans('sentence.updated'));
    ...
    public function destroy($id)
    {
        ...
        if($passenger->message()->count() > 0 or $passenger->seat()->count() > 0){
          return redirect('/passenger')->with('warning', 'First delete it from the message or seat');   
        }
          else{
            $passenger->delete();
            return redirect('/passenger')->with('success', trans('sentence.deleted')); 
    }
}
