...
class DriverController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $driver->save();
        return redirect('/driver')->with('success', trans('sentence.added'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/driver')->with('success', trans('sentence.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        if($driver->bus()->count() > 0){
             return redirect('/driver')->with('warning','First delete it from bus');
        }
            $driver->delete();
        return redirect('/driver')->with('success', trans('sentence.deleted'));
    }
}
