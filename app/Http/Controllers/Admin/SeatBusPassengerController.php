...
class SeatBusPassengerController extends Controller
{
    ...
    {
        //
        return view('admin.buspassenger');
    }
             ...
             $passenger = Passenger::where('p_code','LIKE','%'.$code.'%')->first();
               ...
               $bid=$schedules->bus->id;
                ...
                $schedule=$id;
                    ...
                    $num=' ';
                    return view('admin.seatbuspassenger',compact('bus','passenger','num','seats','schedule'));
    }
    ...
    public function display(Request $request)
    {
        ...
        return view('admin.seat.edit',compact('seat','sets'));
    }
