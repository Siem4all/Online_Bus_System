...
class RouteController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('conductor.route.index', compact('routes'));
    }
    ...
    {
        //
        return view('conductor.route.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $route->save();
        return redirect('/croute')->with('success', trans('sentence.added'));
    }
    ...
    public function edit($id)
    {
        //
        $route = Route::find($id);
        return view('conductor.route.edit',compact('route'));
    }
 ...
 public function search(Request $request)
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/croute')->with('success', trans('sentence.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        if($route->schedule()->count() > 0){
         return redirect('/croute')->with('warning', 'First delete it from schedule');
        }
        else{
             $route->delete();
            return redirect('/croute')->with('success', trans('sentence.deleted'));
        }
