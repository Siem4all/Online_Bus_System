                 ...
                 <div class="card card-info">
                    <div class="form-group row">
                        <div class="form-group mr-auto offset-md-1">
                           ...
                           Route Name:&nbsp<b class="text-success">{{$bus->schedule->route->Route_name}}</b>
                            ...
                            <div class="btn-lg form-group ml-auto offset-md-6">
                                ...
                                <div >Seat Number:<br>
                                    ...
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 1) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 2) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 3) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 4) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 5) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 6) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 7) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 8) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 9) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 10) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 11) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 12) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 13) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 14) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update',15) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                           ...
                           <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 16) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 17) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 18) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 19) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 20) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 21) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 22) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 23) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 24) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 25) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 26) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 27) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 28) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 29) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update',30) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                     <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 31) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 32) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 33) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 34) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 35) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 36) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 37) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 38) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 39) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 40) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 41) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 42) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 43) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 44) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update',45) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                           ...
                           <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 46) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 47) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 48) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 49) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 50) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('useatbus.update', 51) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('useatbus.update', 52) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 53) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 54) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('useatbus.update', 55) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
