    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
           <div class="card card-info">
                <div class="card-header btn-info">{{  trans('sentence.change password here')}}</div>
   
                <div class="card-body">
                    <form method="POST" action="{{ route('uchange-pswd') }}">
                        @csrf 
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{  trans('sentence.confirm password')}}</label>
