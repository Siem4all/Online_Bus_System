...
<div class="row">
    <div class="col-md-6">
<form action="/uschsearch" method="GET" role="form">
  ...
  <tbody>
    ...
    <tr class="table-success">
      ...
      <td>{{$schedule->bus->Bus_number}}</td>
        ...
        <td>{{$schedule->route->Fare}}</td>
        <td><a href="{{ route('ubook.show',$schedule->id)}}" class="btn btn-success">{{  trans('sentence.book')}}</a></td>
    </tr>
    @endforeach
  </tbody>
</table>   
