...
<div class="row">
    <div class="col-md-6">
<form action="/csearch" method="GET" role="form">
...
<div class="col-md-6 text-right">
    <a class="btn btn-success" href="{{ route('conductor.create')}}" >{{  trans('sentence.add conductor')}}</a>
</div>
<table class="table table-responsive table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr class="table-info">
      ...
      <td>
                <a href="{{ route('conductor.edit',$conductor->id)}}" class="btn btn-primary">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
