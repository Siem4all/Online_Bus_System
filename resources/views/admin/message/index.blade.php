...
<div class="row">
    <div class="col-md-5">
     ...
     <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">{{  trans('sentence.passenger fname')}}</label>

                            <div class="col-md-6">
                             <select class="form-control @error('pid') is-invalid @enderror" name="pid">
                               @foreach($passengers as $passenger)
                               <option value="{{$passenger->id}}">{{$passenger->P_fname}} {{$passenger->P_lname}}</option>
                               @endforeach
   ...
   <div class="col-md-7">
            <div class="card card-info">
              ...
              <div class="card-body" style="display: block;">
                  <div class="card-footer">
<form action="/msearch" method="GET" role="form">
...
<table class="table table-responsive table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr class="table-success">
      ...
      <td>
                <a href="{{ route('message.edit',$message->id)}}" class="btn btn-primary">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
        ...
        <td>
             <a href="{{ route('message.show',$message->id)}}" class="btn btn-success">{{  trans('sentence.send')}}</a>
