...
<div class="row">
    <div class="col-md-6">
<form action="/ssearch" method="GET" role="form">
...
<table class="table table-responsive table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr class="table-success">
      ...
      <td>
           <a href="{{ route('seat.edit',$seat->id)}}" class="btn btn-info">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
                <form action="{{ route('seat.destroy', $seat->id)}}" method="post">
                  @csrf
                  @method('DELETE')
