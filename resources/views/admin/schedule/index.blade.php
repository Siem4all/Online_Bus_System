...
<div class="col-md-6 text-right">
    <a class="btn btn-success" href="{{ route('sschedule.create')}}" >{{  trans('sentence.add schedule')}}</a>
</div>
  ...
  <tbody>
    ...
    <tr class="table-success">
      ...
      <td>{{$schedule->bus->Bus_number}}</td>
        ...
        <td><a href="{{ route('book.show',$schedule->id)}}" class="btn btn-success">{{  trans('sentence.book')}}</a></td>
      <td>
                <a href="{{ route('sschedule.edit',$schedule->id)}}" class="btn btn-primary">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
