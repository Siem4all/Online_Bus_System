...
<div class="row">
    <div class="col-md-6">
<form action="/dsearch" method="GET" role="form">
...
<div class="col-md-6 text-right">
    <a class="btn btn-success" href="{{ route('driver.create')}}" >{{  trans('sentence.add driver')}}</a>
</div>
  ...
  <tbody>
    ...
    <tr class="table-info">
      ...
      <td>{{$driver->DOB}}</td>
        ...
        <td>{{$driver->Gender}}</td>
      <td>
                <a href="{{ route('driver.edit',$driver->id)}}" class="btn btn-primary">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
