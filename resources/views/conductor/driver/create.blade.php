    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-info">
                ...
                <h3 class="card-title">{{  trans('sentence.add driver')}}</h3>
                <!-- /.card-tools -->
              </div>
                ...
                <div class="card-body" style="display: block;">
                    <div class="card card-info">
                     <form class="form-horizontal" method="POST" action="{{ route('cdriver.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('dfname') is-invalid @enderror" name="dfname">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('dlname') is-invalid @enderror" name="dlname">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="+251">
