...
<div class="row">
    <div class="col-md-6">
<form action="/cbooksearch" method="GET" role="form">
...
<div class="col-md-6 text-right">
    <a class="btn btn-success" href="{{ route('cbook.create')}}" >{{  trans('sentence.add book')}}</a>
</div>
<table class="table table-responsive table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr class="table-success">
      ...
      <td>
                <a href="{{ route('cbook.edit',$book->id)}}" class="btn btn-primary">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
                <form action="{{ route('cbook.destroy', $book->id)}}" method="post">
                  @csrf
                  @method('DELETE')
