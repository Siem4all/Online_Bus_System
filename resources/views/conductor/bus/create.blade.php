        ...
        <div class="col-md-8">
            <div class="card card-info">
              ...
              <div class="card-body" style="display: block;">
                   <div class="card card-info">
                    <form method="post" action="{{ route('cbus.store')}}">
                        @csrf
                        ...
                        <div class="form-group row">
                           <label for="name" class="col-md-4 col-form-label text-md-right">{{  trans('sentence.station id')}}</label>
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('stationid') is-invalid @enderror" name="stationid"   autocomplete="stationid" autofocus>
                        ...
                        <div class="form-group row">
                           <label for="name" class="col-md-4 col-form-label text-md-right">{{  trans('sentence.driver id')}}</label>
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('did') is-invalid @enderror" name="did"   autocomplete="did" autofocus>
                         ...
                         <div class="form-group row">
                           <label for="name" class="col-md-4 col-form-label text-md-right">{{  trans('sentence.conductor id')}}</label>
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('cid') is-invalid @enderror" name="cid"   autocomplete="cid" autofocus>
