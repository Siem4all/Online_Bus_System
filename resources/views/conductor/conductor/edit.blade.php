        ...
        <div class="col-md-8">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">{{  trans('sentence.update conductor')}}</h3>
                <!-- /.card-tools -->
              </div>
                <div class="card-body" style="display: block;">
                   <div class="card card-info">
                    
                    <form method="post" action="{{ route('cconductor.update', $conductor->id) }}">
                        @method('PATCH') 
                       @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('cfname') is-invalid @enderror" name="cfname" value={{ $conductor->C_fname }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('clname') is-invalid @enderror" name="clname" value={{ $conductor->C_lname }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value={{ $conductor->Phone_no }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="date" class="form-control @error('dob') is-invalid @enderror" name="dob"  autocomplete="phone" value={{ $conductor->DOB }}>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control @error('address') is-invalid @enderror" name="address"   autocomplete="address" value={{ $conductor->Address }}>
                ...
                <option>{{ $conductor->Gender }}</option>
