...
<div class="row justify-content-center">
    <div class="col-md-6">
<form action="/cpsearch" method="GET" role="form">
...
<div class="col-md-6 text-right">
    <a class="btn btn-success" href="{{ route('cpassenger.create')}}" >{{  trans('sentence.add passenger')}}</a>
</div>
<table class="table table-responsive table-hover table-bordered">
  ...
  <tbody>
    ...
    <tr class="table-info">
      ...
      <td>
                <a href="{{ route('cpassenger.edit',$passenger->id)}}" class="btn btn-primary">{{  trans('sentence.edit')}}</a>
            </td>
            <td>
                <form action="{{ route('cpassenger.destroy', $passenger->id)}}" method="post">
                  @csrf
                  @method('DELETE')
