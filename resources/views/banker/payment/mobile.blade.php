...
<div class="row">
    <div class="col-md-4">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">{{  trans('sentence.bank')}}</h3>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="{{ route('bpayment.store')}}">
                        @csrf
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control @error('uid') is-invalid @enderror" id="inputEmail3" name="uid" value="{{ Auth::user()->id }}">
                        @error('uid')
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control @error('pid') is-invalid @enderror" id="inputEmail3" name="pid" placeholder="{{  trans('sentence.passenger id')}}">
                        @error('pid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control @error('rid') is-invalid @enderror" id="inputEmail3" name="rid" placeholder="{{  trans('sentence.route id')}}">
                        @error('rid')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
   ...
   <div class="col-md-8">
            <div class="card card-info">
              ...
              <div >
                  <div class="card-footer">
                <form action="/bpaysearch" method="GET">
    ...
    <tr class="table-success">
      ...
      <td>{{$payment->System}}</td>
        <td>
         ...
         <td>
                <a href="{{ route('bpayment.show',$payment->id)}}" class="btn btn-primary">{{  trans('sentence.send')}}</a>
            </td>
            <td>
