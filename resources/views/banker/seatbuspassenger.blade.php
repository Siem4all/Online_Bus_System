                 ...
                 <div class="card card-info">
                    <div class="form-group row">
                        <div class="form-group mr-auto offset-md-1">
                           ...
                           Route Name:&nbsp<b class="text-success">{{$bus->schedule->route->Route_name}}</b>
                            ...
                            <div class="btn-lg form-group ml-auto offset-md-6">
                                ...
                                <div class="container">Seat Number:<br>
                                    ...
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 1) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 2) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 3) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 4) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 5) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 6) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 7) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 8) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 9) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 10) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 11) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 12) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 13) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 14) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update',15) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                           ...
                           <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 16) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 17) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 18) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 19) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 20) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 21) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 22) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 23) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 24) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 25) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 26) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 27) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 28) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 29) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update',30) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                     <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 31) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 32) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 33) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 34) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 35) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 36) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 37) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 38) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 39) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 40) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                            ...
                            <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 41) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 42) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 43) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 44) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update',45) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                           ...
                           <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 46) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 47) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 48) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 49) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 50) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <br>
                                    <div class="btn-group">
                                    <form method="POST" action="{{ route('bseatbus.update', 51) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                    ...
                                    <form method="POST" action="{{ route('bseatbus.update', 52) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 53) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 54) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                                     ...
                                     <form method="POST" action="{{ route('bseatbus.update', 55) }}">
                                    @method('PATCH') 
                                       @csrf         
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
                     ...
                     <form method="POST" action="{{ route('bseat.store') }}">
                        @csrf        
                                        <input type="hidden" name="pid" value="{{$passenger->id}}" class="form-control">
                                        <input type="hidden" name="busid" value="{{$bus->id}}" class="form-control">
