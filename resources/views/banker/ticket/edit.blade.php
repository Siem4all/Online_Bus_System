        ...
        <div class="col-md-8">
           <div class="card card-info">
              ...
              <div class="card-body" style="display: block;">
                 <div class="card card-info">
                    <form method="POST" action="{{ route('bticket.update', $ticket->id) }}">
                        @method('PATCH') 
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="number" class="form-control @error('pid') is-invalid @enderror" name="pid" value="{{$ticket->passenger_id}}" autocomplete="pid" autofocus>
                                @error('pid')
