...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-light">
    ...
    <!-- Right navbar links -->
      <a  class="nav-link nav-item btn-lg" href="/allow">{{  trans('sentence.permission')}}</a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <a href="/admin" class="nav-link active bg-dark">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview bg-info">
             ...
             <li class="nav-item has-treeview">
            <a href="/conductor" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
            ...
            <ul class="nav nav-treeview bg-info">
              <li class="nav-item">
                <a href="{{route('conductor.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>{{  trans('sentence.add conductor')}}</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('conductor.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview bg-info">
              <li class="nav-item">
                <a href="{{route('route.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
            ...
            <li class="nav-item has-treeview">
            <a href="{{route('sschedule.index')}}" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
