...
@endif
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="{{ asset('images/odaa3.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="/bpassenger" class="nav-link">
            ...
            <ul class="nav nav-treeview bg-info">
              <li class="nav-item">
                <a href="{{route('bpassenger.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{ trans('sentence.add passenger')}}
                </a>
              </li>
              <li class="nav-item">
                <a href="/bpassenger" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{ trans('sentence.manage passenger')}}
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            <a href="/bbus" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
                {{ trans('sentence.bus')}}
            ...
            <a href="/bseat" class="nav-link">
              ...
              <p>
                {{ trans('sentence.seat')}}
                 ...
                 <ul class="nav nav-treeview bg-info">
              <li class="nav-item">
                <a href="{{route('bseat.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{ trans('sentence.add seat')}}
                </a>
              </li>
              <li class="nav-item">
                <a href="/bviewseat" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{ trans('sentence.manage seat')}}
                </a>
              </li>
            </ul>
          </li>
          <li class="nav-item has-treeview">
            <a href="/broute" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
          ...
          <li class="nav-item has-treeview">
            <a href="/bsschedule" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview bg-info">
              <li class="nav-item">
                <a href="{{route('bbook.create')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{ trans('sentence.add book')}}
                </a>
              </li>
              <li class="nav-item">
                <a href="/bbook" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  {{ trans('sentence.manage book')}}
                </a>
              </li>
            </ul>
          </li>
            <li class="nav-item has-treeview">
            <a href="/bpayment" class="nav-link">
              <i class="nav-icon fas fa-copy"></i>
              <p>
            ...
            <li class="nav-item has-treeview">
            <a href="/bbook/show" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                {{ trans('sentence.cancel ticket')}}
              </p>
            </a>
          </li>
            <li class="nav-item has-treeview">
            <a href="/banker-pswd" class="nav-link">
