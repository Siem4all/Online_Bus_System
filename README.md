...
6. Create database with the name odaabus and import the database/odaabus.sql file into it
...
1. Download the <a href="https://getcomposer.org/download/">Composer setup</a> .
